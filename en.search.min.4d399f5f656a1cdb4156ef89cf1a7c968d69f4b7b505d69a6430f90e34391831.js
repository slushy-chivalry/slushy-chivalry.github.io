...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.65a98f6b288c3cdfd58e4b891ed2d7d48f9626d93fc8e230f083d5beaef6a2d7.js',function(){input.required=false;search();});}
