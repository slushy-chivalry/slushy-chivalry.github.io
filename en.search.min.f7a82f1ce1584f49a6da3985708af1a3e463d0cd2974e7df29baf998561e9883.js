...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.72975aba05b57d3892eec25d3d3f604bded1867bf4ba1b8aaa242edf1a6e2cc4.js',function(){input.required=false;search();});}
